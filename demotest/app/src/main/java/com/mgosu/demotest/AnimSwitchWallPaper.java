    ...
    class OutRunEngine extends Engine {
		...
		OutRunEngine() {
        	...
        	for (int i = 0; i< FRONT_RES; i++) {
        		mFrontPicIds[i] = res.getIdentifier("front_day00" + (i + 1), "drawable", "com.mgosu.demotest");
        	}
        	for (int i = 0; i< LEFT_RES; i++) {
        		mLeftPicIds[i] = res.getIdentifier("left_day00" + (i + 1), "drawable", "com.mgosu.demotest");
        	}
        	for (int i = 0; i< RIGHT_RES; i++) {
        		mRightPicIds[i] = res.getIdentifier("right_day00" + (i + 1), "drawable", "com.mgosu.demotest");
        	}
        }
